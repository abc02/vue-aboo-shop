<template>
  <el-container>
    ...
    <el-row type="flex" justify="center" align="middle" v-if="currentGoods" v-loading="isLoading">
    ...
    <el-row type="flex" justify="start" align="middle" v-if="currentGoods" v-loading="isLoading">
...
export default {
  ...
  methods: {
    ...
    ...mapActions(['generateGoodsSpecAction', 'handleCartAddAction'])
  },
  created () {
