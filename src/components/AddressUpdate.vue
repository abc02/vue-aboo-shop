    ...
    <el-container>
        ...
        <el-main>
          <el-container>
              ...
              <el-form-item>
                <el-button type="primary" @click="handleClickAddressUpdate">保存</el-button>
...
export default {
  ...
  methods: {
    handleClickAddressUpdate () {
      this.$emit('on-handle-click-address-update', this.formData)
    },
  ...
  created () {
    this.formData = this.addressUpdate
  }
}
</script>
